...
#    Updated: 2023/11/01 20:19:27 by bda-mota         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CBONUSFILES = ft_lstnew.c ft_lstadd_back.c ft_lstadd_front.c ft_lstlast.c ft_lstsize.c ft_lstclear.c ft_lstdelone.c
OFILES = ${CFILES:%.c=%.o}
